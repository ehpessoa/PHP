...
///////////////////////CONFIGURATION///////////////////////
//////////////////////////////////////////////////////////
$username = "5511971295334";                      // Telephone number including the country code without '+' or '00'.
$password = "RWZG2DSU7vvwvA83SI/NKyijqms=";     // Use registerTool.php or exampleRegister.php to obtain your password
$nickname = "AVON";                          // This is the username (or nickname) displayed by WhatsApp clients.
$target = "5511989620797";                   // Destination telephone number including the country code without '+' or '00'.
...
//$w->sendSetProfilePicture("demo/logo-avon.png");
